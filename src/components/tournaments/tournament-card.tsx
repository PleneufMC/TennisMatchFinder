        ...
        <div className="space-y-2">
          ...
          {tournament.participants && tournament.participants.length > 0 && (
            <div className="mt-3 space-y-2">
              ...
              {registrationOpen && participantCount < tournament.maxParticipants && (
                <p className="text-xs text-muted-foreground italic">
                  {participantCount === 0 
                    ? "Soyez le premier à vous inscrire !" 
                    : participantCount < 3 
                      ? "Rejoignez-les, il reste des places !"
                      : `Encore ${tournament.maxParticipants - participantCount} places disponibles`
                  }
                </p>
              )}
            </div>
          ...
          {(!tournament.participants || tournament.participants.length === 0) && registrationOpen && (
